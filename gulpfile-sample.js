...
gulp.task('scripts', function() {
  return gulp.src(['_/components/js/scrollspy.js','_/components/js/scripts.js','_/components/js/imagesloaded.pkgd.min.js','_/components/js/masonry.pkgd.min.js','_/components/js/classie.js','_/components/js/cbpGridGallery.js' ])
    // .pipe(jshint())
