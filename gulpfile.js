...
gulp.task('scripts', function() {
  return gulp.src(['_/components/js/scrollspy.js','_/components/js/imagelightbox.js','_/components/js/waypoints.js','_/components/js/jquery.scrollme.js','_/components/js/waypoints.sticky.js','_/components/js/scripts.js' ])
    // .pipe(jshint())
